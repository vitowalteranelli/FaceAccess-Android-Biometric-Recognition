...
public class Preprocess extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) 
    	...
    	PrintWriter out = response.getWriter();
         ...
         //Mat testImage = org.bytedeco.javacpp.opencv_highgui.imread(rootworking_trash+"/4.png", org.bytedeco.javacpp.opencv_highgui.CV_LOAD_IMAGE_GRAYSCALE);
         ...
         for (File image : imageFiles) {
             ...
             org.bytedeco.javacpp.opencv_highgui.imwrite(image.getAbsolutePath(),img2);
         ...
         System.out.println("immagini ridimensionate ");
         out.write("<p>"+counter+" immagini sono state ridimensionate..</p>");
         out.write("</body></html>");
